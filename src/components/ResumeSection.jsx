            ...
            <div className="space-y-8">
              ...
              <div className="relative">
                ...
                <div className="bg-gray-800/80 backdrop-blur-sm p-4 rounded-lg shadow-lg">
                  ...
                  <h3 className="text-lg font-bold mb-2 text-white mt-1">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Worked on responsive UI designs and frontend features using
                    HTML, CSS, JavaScript, and React.js. Focused on creating
              ...
              <div className="relative">
                ...
                <div className="bg-gray-800/80 backdrop-blur-sm p-4 rounded-lg shadow-lg">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Developed and optimized websites for performance and
                    responsiveness. Worked with HTML, CSS, JavaScript, React,
                    and Firebase to build functional projects.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="bg-gray-800/80 backdrop-blur-sm p-4 rounded-lg shadow-lg">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Created modern, responsive web pages and implemented
                    interactive UI components. Used React.js, Tailwind CSS, and
                    API integrations to deliver engaging user experiences.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="bg-gray-800/80 backdrop-blur-sm p-4 rounded-lg shadow-lg">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Providing freelance services in WordPress and Shopify
                    development, including custom theme customization, store
                    setup, and optimization. Focused on creating professional,
                    responsive, and high-performing eCommerce websites.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex-1 pr-8 lg:pr-12">
                  <div className="bg-gray-800/80 backdrop-blur-sm p-6 lg:p-8 rounded-lg shadow-lg text-left">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Worked on responsive UI designs and frontend features
                      using HTML, CSS, JavaScript, and React.js. Focused on
              ...
              <div className="relative flex items-center">
                <div className="flex-1 pr-8 lg:pr-12">
                  <div className="bg-gray-800/80 backdrop-blur-sm p-6 lg:p-8 rounded-lg shadow-lg text-left">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Created modern, responsive web pages and implemented
                      interactive UI components. Used React.js, Tailwind CSS,
                      and API integrations to deliver engaging user experiences.
                    </p>
                  </div>
                </div>
                <div className="absolute left-1/2 transform -translate-x-1/2 w-5 h-5 bg-yellow-300 rounded-full border-4 border-black shadow-lg"></div>
