...
export default function PortfolioSection() {
  ...
  return (
    <motion.section
      ...
      initial={{ opacity: 0, y: 100 }}       // niche se upar ayega
      whileInView={{ opacity: 1, y: 0 }}    // jab viewport me ayega to animate hoga
      transition={{ duration: 0.8, ease: "easeOut" }}
      viewport={{ once: false }}             // ek bar hi animation chale
    >
