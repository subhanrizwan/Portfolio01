      ...
      <div className="max-w-7xl mx-auto">
            ...
            <form className="space-y-8">
              <div>
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full bg-transparent border-b border-gray-600 pb-3 text-white placeholder-gray-400 focus:border-lime-400 focus:outline-none transition-colors"
                />
              </div>
              <div>
                <input
              ...
              <div>
                <textarea
                  ...
                  rows={6}
                  className="w-full bg-transparent border-b border-gray-600 pb-3 text-white placeholder-gray-400 focus:border-lime-400 focus:outline-none resize-none transition-colors"
                ></textarea>
              </div>
              <div>
                <button
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 mb-4 md:mb-0">Copyright 2022 - All right reserved</div>
